...
py::object empty_environment = py::none();

py::object
_begin_environment(int D)
{
  if (D == 1)
    {
...
py::object
_update_left_environment(py::object B, py::object A, py::object rho)
{
...
py::object
_update_right_environment(py::object B, py::object A, py::object rho)
{
  if (!is_array(A) || !is_array(B) || !is_array(rho) || (array_ndim(B) != 3)
      || (array_ndim(A) != 3) || (array_ndim(rho) != 2))
    {
...
Weight
_end_environment(py::object rho)
{
  auto A = to_array(rho);
 ...
 */
Weight
_join_environments(py::object rhoL, py::object rhoR)
{
...
Weight
scprod(py::object bra, py::object ket)
{
