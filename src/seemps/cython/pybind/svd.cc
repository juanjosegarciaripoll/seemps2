...
static int
_dgesvd(double* A, double* U, double* s, double* VT, int m, int n, int r)
{
  int lwork, info;
  char jobu = (A == U) ? 'O' : 'S';
  char jobvt = (A == VT) ? 'O' : 'S';
...
static int
_zgesvd(std::complex<double>* A, std::complex<double>* U, double* s,
...
static int
_dgesdd(double* A, double* U, double* s, double* VT, int m, int n, int r)
{
  int lwork, info;
...
static int
_zgesdd(std::complex<double>* A, std::complex<double>* U, double* s,
        std::complex<double>* VT, int m, int n, int r)
{
  int lwork, info;
  char jobz = (A == U || A == VT) ? 'O' : 'S';
